...
> 생성 시각: 2026-08-15T04:37:26.523Z
...
|---|---|---|
| **[CGV](http://www.cgv.co.kr)**<br><sub>`cgv`</sub> | support_url, 앱 ID | `/cjmweb/join.do` → hints.signup_url |
| **[쿠팡이츠](https://www.coupangeats.com)**<br><sub>`coupang-eats`</sub> | signup_url, support_url | `/join` → 404<br>`/signup` → 404<br>`/member/join` → 404<br>`/register` → 404<br>`/user/join` → 404 |
| **[G마켓](https://www.gmarket.co.kr)**<br><sub>`gmarket`</sub> | support_url | `/signup/privateBuyer` → hints.signup_url |
| **[여기어때](https://www.yeogi.com)**<br><sub>`goodchoice`</sub> | support_url, 앱 ID | `/login` → hints.signup_url |
...
| **[고속버스통합예매](https://www.kobus.co.kr)**<br><sub>`kobus`</sub> | support_url, 앱 ID | `/mbrs/mbrsjoin/mbrsJoin.do` → hints.signup_url |
| **[KT](https://www.kt.com)**<br><sub>`kt`</sub> | support_url, 앱 ID | `/identify/personal` → hints.signup_url |
| **[LG유플러스](https://www.lguplus.com)**<br><sub>`lguplus`</sub> | 앱 ID | `/login` → hints.signup_url |
...
| **[올리브영](https://www.oliveyoung.co.kr)**<br><sub>`oliveyoung`</sub> | support_url, 앱 ID | `/cjmweb/join.do` → hints.signup_url |
| **[올리브영 글로벌](https://global.oliveyoung.com)**<br><sub>`oliveyoung-global`</sub> | 앱 ID | `/member/join` → hints.signup_url |
...
| **[야놀자](https://www.yanolja.com)**<br><sub>`yanolja`</sub> | support_url | `/v3/login` → hints.signup_url |
| **[예스24 티켓](http://ticket.yes24.com)**<br><sub>`yes24-ticket`</sub> | 앱 ID | `/Member/Join/Accept.aspx` → hints.signup_url |
